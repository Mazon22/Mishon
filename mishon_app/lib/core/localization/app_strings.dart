...
class AppStrings {
  ...
  String get forYouFeedDescription => isRu
  ...
  String get followingFeedDescription => isRu
  ...
  String get feedRecommendationsWarmupTitle => isRu
      ? 'Рекомендации настраиваются'
      : 'Your recommendations are warming up';
  String get feedFollowingEmptyTitle => isRu
      ? 'Пока нет постов по подпискам'
      : 'No subscription posts yet';
  String get feedRecommendationsWarmupSubtitle => isRu
  ...
  String get feedFollowingEmptySubtitle => isRu
  ...
  String get feedShowingCachedPosts => isRu
  ...
  String get mediaWillAppearHere => isRu
      ? 'Изображения из постов появятся здесь.'
      : 'Images from posts will appear here.';
  String get nothingLikedYet => isRu
      ? 'Пока ничего не понравилось'
      : 'Nothing liked yet';
  String get likedPostsWillAppearHere => isRu
  ...
  String get actionCannotBeUndone => isRu
  ...
  String lastSeenYesterdayAt(String time) => isRu
      ? 'был в сети вчера в $time'
      : 'last seen yesterday at $time';
  String lastSeenDaysAgoAt(int days, String time) => isRu
      ? 'был в сети $days д. назад в $time'
      : 'last seen $days d. ago at $time';

  String get profileSetupTitle =>
      isRu ? 'Изменить профиль' : 'Edit profile';
  String get profileSetupSectionTitle =>
      isRu ? 'Профиль' : 'Profile';
  String get profileSetupSectionSubtitle => isRu
  ...
  String get aboutHint => isRu
      ? 'Расскажите немного о себе'
      : 'Tell people a little about yourself';
  String get changeAvatar =>
      isRu ? 'Сменить аватар' : 'Change avatar';
  String get removeAvatar =>
      isRu ? 'Удалить аватар' : 'Remove avatar';
  String get changeBanner =>
      isRu ? 'Сменить баннер' : 'Change banner';
  String get removeBanner =>
      isRu ? 'Удалить баннер' : 'Remove banner';
  String get save => isRu ? 'Сохранить' : 'Save';
  String get usernameMinLength => isRu
      ? 'Минимальная длина - 5 символов.'
      : 'Minimum length is 5 characters.';
  String get usernameInvalid => isRu
      ? 'Имя пользователя может содержать только a-z, 0-9, . или _'
      : 'Username must contain only a-z, 0-9, . or _';
  String get checkingUsername => isRu
      ? 'Проверяем имя пользователя...'
      : 'Checking username...';
  String get usernameAvailable => isRu
      ? 'Имя пользователя доступно'
      : 'Username available';
  String get usernameUnavailable => isRu
      ? 'Это имя пользователя уже занято.'
      : 'This username is already taken.';
  String get usernameVerifyFailed => isRu
  ...
  String get noFollowingYet =>
      isRu ? 'Пока нет подписок' : 'No following yet';
  String get followersWillAppearHere => isRu
      ? 'Когда на вас подпишутся, они появятся здесь.'
      : 'Followers will appear here when people subscribe to you.';
  String get followingWillAppearHere => isRu
